...
cp cron/cron_db_backup_example_all.sh cron/net_tcp_config.sh devel/sync_lock.sh devel/sync_unlock.sh $GOPATH/bin/ || exit 2
cp devel/all_projects.txt /etc/gha2db/
