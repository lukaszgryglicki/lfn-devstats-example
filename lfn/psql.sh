...
GHA2DB_PROJECT=lfn PG_DB=lfn GHA2DB_LOCAL=1 GHA2DB_OLDFMT=1 GHA2DB_EXACT=1 ./gha2db 2014-01-01 0 2014-12-31 23 'iovisor,mininet,opennetworkinglab,opensecuritycontroller,open-switch,p4lang,openbmp,tungstenfabric,opencord' 2>>errors.txt | tee -a run.log || exit 4
...
GHA2DB_PROJECT=lfn PG_DB=lfn GHA2DB_LOCAL=1 ./vars || exit 10
